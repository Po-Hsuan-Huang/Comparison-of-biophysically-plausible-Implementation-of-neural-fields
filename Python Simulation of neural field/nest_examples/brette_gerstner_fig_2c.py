...
import pylab
from matplotlib import lines as pl
...
nest.SetStatus(neuron,{"a": 4.0, "b":80.5,'V_reset':-70.6,'V_peak':20.0})
...
''' we plot the stimulus together'''
pylab.axis([0,1000,0,1000])
pylab.ylabel('dc stimulus (pA) ')
x1 = pylab.linspace(0,200,200)
x2 = pylab.linspace(500,1000,500)
y1 = 500*pylab.ones(200)
y2 = 800*pylab.ones(500)
pylab.plot( x1, y1, x2, y2)
pylab.show()

state_v = nest.GetStatus(voltmeter)
