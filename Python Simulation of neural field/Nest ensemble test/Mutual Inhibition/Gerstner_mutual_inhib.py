...
J_in_ei       = 2*J_in_mean * pl.rand(NI,NE)    #J_in  ex->in
...
syn_params_in = {"model": "inhibitory", 'weight': J_in_ei, 'delay': delay }
...
'Inhibitory inhibit inhibitory'
nest.Connect(nodes_in, nodes_in, conn_params_in, syn_params_in)
