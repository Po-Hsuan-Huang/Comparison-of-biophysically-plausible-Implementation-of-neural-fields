# -*- coding: utf-8 -*-
"""
Created on Mon Nov 30 19:15:05 2015
...
#    nest.SetStatus(neuron,{"I_e": 0.0,'V_reset':-70.6,'E_L':-70.6,'V_th':-50.4,'tau_m':9.37,'t_ref':2.0,'tau_syn':144.0})
    nest.SetStatus(neuron,{"C_m": C_m,'V_reset':-70.6,'E_L':-70.6,'V_th':-50.4,'tau_m':9.37,'t_ref':2.0,'tau_syn':144.0})
...
#    pl.subplot(211)
    ...
    pl.xlabel("time (ms)")
    pl.ylabel("V_m (mV)")
    pl.plot(times, potentials, label= '%.1f'% C_m)
    pl.axis([0,100,-80,20])
    pl.legend(loc=2)
...
pl.plot(np.arange(start, stop +step, step),rate)
pl.xlabel('C_m /pF')
pl.ylabel('rate /Hz')