# -*- coding: utf-8 -*-
"""
Created on Wed Dec  2 14:34:07 2015
...
of injecting current stimulaiton. The firing rate defined here is  1/ISI (Hz)
This function differ from the previous version Gerstner_test_ISI2.py 
by automize the simulation loop withouth resetting the kernel, therefore the 
rebuild time is spared.
...
#    nest.SetKernelStatus({ 'local_num_threads': 4 }) 
    ...
    This is important, since the slope of the action potential is very steep.
    '''
