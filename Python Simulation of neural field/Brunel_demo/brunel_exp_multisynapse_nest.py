...
nest.SetStatus(espikes,[{'start':500.,'stop':700.,"label": "brunel-py-ex",
                         "withtime": True,
                         "withgid": True,
                         "to_file": True}])

nest.SetStatus(ispikes,[{'start':500.,'stop':700.,"label": "brunel-py-in",
                         "withtime": True,
                         "withgid": True,
                         "to_file": True}])
...
stri='g= %.f, n_ex/n_th = %.f'%(g, eta)

nest.raster_plot.from_device(espikes, hist=True, title=stri )
pylab.show()