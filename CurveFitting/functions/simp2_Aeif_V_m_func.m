%{
 Simplified No.2 Adaptive Exponential LIF model ('AdEx'/'aEIF', Brette & Gerstner (2005))
 Calculating the firing rate for a single neuron, applying the different
 current amplitude.
 It differs from the original funciton by dropping the exponential spike
 approximation term is the membrane potential ODE, and neglecting
 subthreshold adaptation in the adaptive current ODE.
...
function [v,FR] = simp_Aeif_V_m(Tau_R,Taum,Vt,a_0,I_e,dt)
