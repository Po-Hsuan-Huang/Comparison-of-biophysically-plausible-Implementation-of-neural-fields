...
function   [ fit_paras ,fit_error]= simp2_aeif_least_square_fit_func(fit_paras)
...
[fit_paras,fit_error] = lsqcurvefit(fun_ref,x_0,xdata,ydata) ; % fit_error is the 2-norm of the least square error
